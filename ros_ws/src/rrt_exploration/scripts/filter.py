...
def node():
    ...
    threshold = rospy.get_param('~costmap_clearing_threshold', 20)
...
# clearing old frontiers
        ...
        while z < len(centroids):
            ...
            if (cond or (informationGain(mapData, [centroids[z][0], centroids[z][1]], info_radius*0.5)) < 0.05):
